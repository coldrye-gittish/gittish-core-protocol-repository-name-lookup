# gittish-core-protocol-repository-name-lookup

This package defines the service interface that is responsible for looking up
repository names in the context of a given organization.

The service supports the following use cases

* check whether a given repository name was already taken
* look up a list of matching repository names based on user input
...
```
cd <WORKSPACE_ROOT>/gittish-core-protocol-repository-name-lookup
./configure
```
